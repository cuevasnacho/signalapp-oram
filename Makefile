...
build/test_position_map: src/bucket.c src/tree_path.c src/stash.c src/path_oram.c src/position_map.c build/jposition_map.s tests/test_position_map.c syscall/jasmin_syscall.o
	$(CC) $(CFLAGS) -o build/test_position_map src/bucket.c src/tree_path.c src/stash.c src/path_oram.c src/position_map.c build/jposition_map.s tests/test_position_map.c syscall/jasmin_syscall.o
